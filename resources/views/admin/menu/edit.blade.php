                    ...
                    <form method="POST" action="{{ route('admin.menu.update', $menu) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('description', $menu->description) }}</textarea>
                            ...
                            <div>
                                <x-input-label for="image" :value="__('Resim (Değiştirmek istiyorsanız yükleyin)')" />
                                ...
                                @if($menu->image_path)
                                    <div class="mt-2">
                                        <p class="text-xs text-gray-500 mb-1">Mevcut Resim:</p>
                                        <img src="{{ Storage::url($menu->image_path) }}" alt="" class="h-16 rounded">
                                    </div>
                                @endif
                            </div>
